...
$html = $html.Replace('assets/orbit.mp4', (DataUri (Join-Path $project 'assets\orbit.mp4') 'video/mp4'))
$html = $html.Replace('assets/logo.webp', (DataUri (Join-Path $project 'assets\logo.webp') 'image/webp'))
1..5 | ForEach-Object {
  $html = $html.Replace("assets/cloud-$_.png", (DataUri (Join-Path $project "assets\cloud-$_.png") 'image/png'))
}
$html = $html.Replace('assets/cloud-cinematic-v1.png', (DataUri (Join-Path $project 'assets\cloud-cinematic-v1.png') 'image/png'))
